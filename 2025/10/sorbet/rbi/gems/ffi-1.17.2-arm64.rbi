...
class FFI::Struct
  ...
  def self.alloc_in(*, **); end
  def self.alloc_inout(*, **); end
  def self.alloc_out(*, **); end
  ...
  def self.new_in(*, **); end
  def self.new_inout(*, **); end
  def self.new_out(*, **); end
...
class FFI::DynamicLibrary
  ...
  def self.load_library(name, flags); end
  def self.open(arg0, arg1); end
  def self.try_load(libname, flags, errors); end
end
...
class FFI::LibraryPath
  def abi_number; end
  def full_name; end
  def initialize(name, abi_number: nil, root: nil); end
  def name; end
  def root; end
